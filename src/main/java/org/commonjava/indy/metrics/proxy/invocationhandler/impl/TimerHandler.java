...
public class TimerHandler<T> {
    ...
    public Object operation(MetricRegistry metricRegistry, T proxyInstance, Method method, Object[] parameters,IndyTimers indyTimers) throws Throwable{
        logger.info("call in TimerHandler.operation");
        Timer.Context contextTime  = metricRegistry.timer(name(indyTimers.c(),indyTimers.name())).time();
